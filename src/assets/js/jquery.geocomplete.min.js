!(function (t, i, o, e) {
  ...
  var n = {
    ...
    r =
      "id url website vicinity reference name rating international_phone_number icon formatted_phone_number".split(
        " "
      );
  t.extend(s.prototype, {
    ...
    initMap: function () {
      if (this.options.map) {
        if ("function" == typeof this.options.map.setCenter)
          return (this.map = this.options.map), e;
        (this.map = new google.maps.Map(
          t(this.options.map)[0],
          this.options.mapOptions
        )),
          google.maps.event.addListener(
            this.map,
            "click",
            t.proxy(this.mapClicked, this)
          );
      }
    },
    initMarker: function () {
      if (this.map) {
        ...
        i.disabled ||
          ...
          google.maps.event.addListener(
            this.marker,
            "dragend",
            t.proxy(this.markerDragged, this)
          ));
      }
    },
    initGeocoder: function () {
      ...
      this.options.country &&
        (i.componentRestrictions = { country: this.options.country }),
        ...
        google.maps.event.addListener(
          this.autocomplete,
          "place_changed",
          t.proxy(this.placeChanged, this)
        ),
        this.$input.keypress(function (t) {
          return 13 === t.keyCode ? !1 : e;
        }),
        this.$input.bind(
          "geocode",
          t.proxy(function () {
    ...
    initLocation: function () {
      ...
      if (i) {
        ...
        i instanceof Array && (t = new google.maps.LatLng(i[0], i[1])),
          i instanceof google.maps.LatLng && (t = i),
          t &&
      ...
      this.options.bounds &&
        ...
        (i.bounds =
          this.options.bounds === !0
            ...
            : this.options.bounds),
        this.options.country && (i.region = this.options.country),
        this.geocoder.geocode(i, t.proxy(this.handleGeocode, this));
    },
    handleGeocode: function (t, i) {
      if (i === google.maps.GeocoderStatus.OK) {
        var o = t[0];
        this.$input.val(o.formatted_address),
          this.update(o),
          t.length > 1 && this.trigger("geocode:multiple", t);
    ...
    setDetail: function (t, i) {
      i === e
        ? (i = "")
        : "function" == typeof i.toUrlValue && (i = i.toUrlValue()),
        t.is(":input") ? t.val(i) : t.text(i);
    },
    ...
    (t.fn.geocomplete = function (i) {
      ...
      if ("string" == typeof i) {
        ...
        return "function" == typeof n
          ? (n.apply(e, Array.prototype.slice.call(arguments, 1)), t(this))
          : (2 == arguments.length && (n = arguments[1]), n);
      }
